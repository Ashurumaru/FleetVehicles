...
namespace FleetVehicles.Data
{
    ...
    public partial class FleetVehiclesEntities : DbContext
    {
        public FleetVehiclesEntities()
            : base("name=FleetVehiclesEntities")
        {
        }
        ...
        public virtual DbSet<FleetCars> FleetCars { get; set; }
        public virtual DbSet<InsurancePolicy> InsurancePolicy { get; set; }
        public virtual DbSet<OrderAdditionalService> OrderAdditionalService { get; set; }
